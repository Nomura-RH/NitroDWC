...
static void DWCs_AddDelayMessage (DArray array,
                      u16 delayValue,
                      GT2Connection connection,
                      int filterID,
                      const u8 * message,
...
static int DWCs_GetOutgoingBufferFreeSize (u8 aid)
{
...
#ifndef SDK_FINALROM
    static void DWCs_SendFilterCallbackDrop (GT2Connection connection,
                                int filterID,
    ...
    static void DWCs_RecvFilterCallbackDrop (GT2Connection connection,
                                int filterID,
                                GT2Byte * message,
                                int size,
                                GT2Bool reliable)
    ...
    static void DWCs_SendFilterCallbackDelay (GT2Connection connection,
                                int filterID,
                                const u8 * message,
                                int size,
                                BOOL reliable)
    ...
    static void DWCs_RecvFilterCallbackDelay (GT2Connection connection,
                                int filterID,
                                u8 * message,
                                int size,
                                BOOL reliable)
