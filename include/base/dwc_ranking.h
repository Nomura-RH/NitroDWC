...
extern DWCRnkError DWC_RnkShutdown(void);
...
extern DWCRnkError DWC_RnkCancelProcess(void);
extern DWCRnkError DWC_RnkProcess(void);
extern DWCRnkState DWC_RnkGetState(void);
