...
GPResult gpiSetInfos(
    GPConnection *connection,
    GPEnum info,
    const char *value
);

GPResult gpiSetInfod(
    GPConnection *connection,
    GPEnum info,
    int day,
    int month,
...
GPResult gpiSetInfoMask(
    GPConnection *connection,
    GPEnum mask
);

void gpiInfoCacheToArg(
...
GPResult gpiProcessGetInfo(
    GPConnection *connection,
    GPIOperation *operation,
    const char *input
);

GPResult gpiSendGetInfo(
    GPConnection *connection,
    int profileid,
    int operationid
);

GPResult gpiAddLocalInfo(
    GPConnection *connection,
    GPIBuffer *buffer
);
